...
public class DetailedListPreference  extends ListPreference {
    ...
    public DetailedListPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onPrepareDialogBuilder(Builder builder) {
        ...
        ListAdapter adapter = new ArrayAdapter<String>(
                getContext(), R.layout.pref_detailedlist, mEntriesString) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    convertView = inflater.inflate(R.layout.pref_detailedlist, null);
        ...
        builder.setAdapter(adapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
				 ...
				 */
                DetailedListPreference.this.onClick(dialog, DialogInterface.BUTTON_POSITIVE);
                dialog.dismiss();
            }
        });
